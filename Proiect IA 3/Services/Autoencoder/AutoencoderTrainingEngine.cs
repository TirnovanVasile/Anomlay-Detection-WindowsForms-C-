...
{
    public class AutoencoderTrainingEngine
    {
        private NeuralNetwork network;
        private AutoencoderDataManager dataManager; 
        ...
        public AutoencoderTrainingEngine(NeuralNetwork network, AutoencoderDataManager dataManager)
        {
